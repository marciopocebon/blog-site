      ...
      <div className="bg-[#023047] flex justify-center items-center min-h-[100vh] w-[100vw]">
        <div className="flex flex-col justify-center items-center bg-white w-8/12 h-10/12 shadow-2xl drop-shadow-2xl">
          <Image
            ...
            alt=""
          />
          <button className="flex items-center rounded-full border-[1px] border-gray-400 w-8/12 m-5 p-1 shadow-md focus-within:outline-none hover:bg-gray-50 active:bg-gray-100">
            <Image
              width={200}
              height={200}
              objectFit="contain"
