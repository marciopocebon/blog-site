...
function Write() {
  ...
  return (
    <div className="flex flex-col">
      ...
      <textarea
        className="font-serif placeholder-thin text-2xl w-10/12 overflow-hidden	placeholder-[#b3b3b1] pt-4 ml-4 pl-6 xl:ml-[225px] 2xl:ml-[380px] focus-within:outline-none"
